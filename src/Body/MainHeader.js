...
function Header() {
    ...
    if (!opened) {
        ...
        return <nav onClick={menuClickHandler} className="mainmenu">
            ...
            <ul className="bottomMenu">
                <li className="bottommenuitem">Lekcija 2</li>
            ...
            <ul className="bottomMenu">
                <li className="bottommenuitem">Lekcija 3</li>
            ...
            <ul className="bottomMenu">
                <li className="bottommenuitem">Lekcija 4</li>
            ...
            <ul className="bottomMenu">
                <li className="bottommenuitem">Lekcija 5</li>
